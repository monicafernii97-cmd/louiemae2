...
export const ShopLandingPage: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'fashion', title: 'The Mae Collective', image: home.categoryImages.fashion, link: '#collection/fashion', subtitle: 'Apparel' },
    { id: 'kids', title: 'Louie Kids & Co.', image: home.categoryImages.kids, link: '#collection/kids', subtitle: 'Little Ones' },
    { id: 'journal', title: 'The Journal', image: home.categoryImages.journal, link: '#blog', subtitle: 'Stories' },
  ];
    ...
    <div className="bg-cream min-h-screen pt-32 pb-20">
       ...
       <section className="px-6 md:px-12 mb-20">
        <div className="container mx-auto flex flex-col items-center">
          ...
          <FadeIn delay={200} className="w-full aspect-[16/10] md:aspect-[21/9] overflow-hidden rounded-[3rem] shadow-sm">
            <img 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 auto-rows-[minmax(300px,auto)]">
               {categories.map((cat, idx) => (
                  <FadeIn 
                    key={cat.id} 
                    delay={idx * 100} 
                    className={`group cursor-pointer relative overflow-hidden rounded-[2.5rem] shadow-sm border border-earth/5 ${
                        idx === 0 ? 'md:row-span-2 h-[600px] md:h-auto' : 'h-[300px] md:h-[400px]'
                    }`}
                  >
                     <div 
