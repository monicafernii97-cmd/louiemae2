    ...
    <div className="bg-cream min-h-screen w-full overflow-hidden pt-32 pb-32">
       ...
       <section className="px-6 md:px-12 mb-20 md:mb-32">
          <div className="container mx-auto max-w-5xl">
             ...
             <FadeIn delay={200} className="relative w-full aspect-[16/9] md:aspect-[21/9] overflow-hidden rounded-sm mb-16 shadow-sm mx-auto">
                <div className="absolute inset-0 bg-black/5 z-10"></div>
                <img 
                   src={story.hero.image} 
                   alt="Our Journey" 
                   className="w-full h-full object-cover grayscale-[20%] scale-105 hover:scale-100 transition-transform duration-[3s] ease-out"
                />
             </FadeIn>
          </div>
       </section>
